                            ...
                            <div className="collapse navbar-collapse " id="navbarTogglerDemo02">
                                <ul className="navbar-nav me-auto mb-2 mb-lg-0  ">
                                    <li className="nav-item ">
                                        <Link className="nav-link text-dark" aria-current="page" to="/cart"><h5><i className="fa-solid fa-cart-shopping text-info"></i> Cart</h5></Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link text-dark" to="/wishlist"><h5><i className="fa-solid fa-heart text-danger"></i> Wishlist</h5></Link>
                                    </li>
                                </ul>
