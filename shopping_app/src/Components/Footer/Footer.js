                ...
                <div className="card" style={{ backgroundColor: "#0099ff", borderRadius: "0px", height: "auto" }}>
                    <div className="card-body  text-center" >
                        ...
                        <p className="card-text " style={{ fontWeight: "900", fontSize: "200%", textDecoration: "none", letterSpacing: "15px" }}>
                            <a href="https://www.facebook.com/profile.php?id=100009449169869" ><i className="fa-brands fa-twitter text-light"></i></a>
                            <a href="https://www.instagram.com/raghavendra_machani/"><i className="fa-brands fa-facebook text-light "></i></a>
